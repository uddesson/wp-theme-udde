<!-- Creates a new custom query to display only four posts when front page-template page is used.  -->
<?php $display_four_posts = new WP_Query( 'no_found_rows=true&posts_per_page=4' ); 
    ...
    On the topic I found this post helpful: https://flavio.tordini.org/speed-up-wordpress-get_posts-and-query_posts-functions */

/* Checks if there are four posts to be displayed */
if ( $display_four_posts->have_posts() ) : ?>
    <div class="row justify-content-md-center">

        <!-- Loops out the four latest posts -->
        <?php  while ( $display_four_posts->have_posts() ) : $display_four_posts->the_post(); ?>
    
            <div class="col-10 col-md-8 col-lg-5 offset-1 offset-md-0 post-content-front">
